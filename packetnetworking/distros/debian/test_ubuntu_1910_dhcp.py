...
@pytest.fixture
def ubuntu_1910_dhcp_network(generic_debian_dhcp_network):
    def _builder(**kwargs):
        return generic_debian_dhcp_network("ubuntu", "19.10", **kwargs)

    return _builder


def test_ubuntu_1910_dhcp_task_etc_network_interfaces(
    ubuntu_1910_dhcp_network
):
    """Validates /etc/network/interfaces for dhcp"""

    builder = ubuntu_1910_dhcp_network(public=True)
...
def test_ubuntu_1910_etc_hostname_configured(ubuntu_1910_dhcp_network):
    """
    Validates /etc/hostname is configured correctly
    """
    builder = ubuntu_1910_dhcp_network()
    tasks = builder.render()
    result = dedent(
        """\
        {hostname}
...
def test_ubuntu_1910_etc_hosts_configured(ubuntu_1910_dhcp_network):
    """
...
# pylama:ignore=E501
def test_ubuntu_1910_persistent_interface_names(ubuntu_1910_dhcp_network):
    """
