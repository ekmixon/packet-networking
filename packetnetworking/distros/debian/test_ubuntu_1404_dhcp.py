...
@pytest.fixture
def ubuntu_1404_dhcp_network(generic_debian_dhcp_network):
    def _builder(**kwargs):
        return generic_debian_dhcp_network("ubuntu", "14.04", **kwargs)

    return _builder


def test_ubuntu_1404_dhcp_task_etc_network_interfaces(
    ubuntu_1404_dhcp_network
):
    """Validates /etc/network/interfaces for dhcp"""

    builder = ubuntu_1404_dhcp_network(public=True)
...
def test_ubuntu_1404_etc_resolvers_configured(ubuntu_1404_dhcp_network, fake):
    """
    Validates /etc/resolv.conf is configured correctly
    """
    builder = ubuntu_1404_dhcp_network()
    resolver1 = fake.ipv4()
    resolver2 = fake.ipv4()
...
def test_ubuntu_1404_etc_hostname_configured(ubuntu_1404_dhcp_network):
    """
...
def test_ubuntu_1404_etc_hosts_configured(ubuntu_1404_dhcp_network):
    """
...
# pylama:ignore=E501
def test_ubuntu_1404_persistent_interface_names(ubuntu_1404_dhcp_network):
    """
