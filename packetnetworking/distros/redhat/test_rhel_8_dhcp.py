...
@pytest.fixture
def rhel_8_dhcp_network(generic_redhat_dhcp_network):
    def _builder(**kwargs):
        return generic_redhat_dhcp_network("redhatenterprise", "8", **kwargs)

    return _builder


def test_rhel_8_dhcp_task_etc_sysconfig_network(rhel_8_dhcp_network):
    """Validates /etc/sysconfig/network for dhcp"""
    builder = rhel_8_dhcp_network(public=True)
...
def test_rhel_8_dhcp_task_etc_sysconfig_network_scripts_ifcfg_enp0(
    rhel_8_dhcp_network
):
...
def test_rhel_8_private_dhcp_task_etc_sysconfig_network_scripts_ifcfg_enp0(
    rhel_8_dhcp_network
):
    """
    ...
    """
    builder = rhel_8_dhcp_network(public=False)
    tasks = builder.render()
    result = dedent(
        """\
        DEVICE=enp0
...
def test_rhel_8_private_route_task_etc_sysconfig_network_scripts_route_enp0_with_custom_private_subnets(
    ...
    builder = rhel_8_dhcp_network(public=True, metadata=subnets)
    tasks = builder.render()
    result = dedent(
        """\
...
def test_rhel_8_etc_resolvers_configured(rhel_8_dhcp_network, fake):
    """
    Validates /etc/resolv.conf is configured correctly
    """
    builder = rhel_8_dhcp_network()
    resolver1 = fake.ipv4()
    resolver2 = fake.ipv4()
...
def test_rhel_8_etc_hostname_configured(rhel_8_dhcp_network):
    """
...
def test_rhel_8_etc_hosts_configured(rhel_8_dhcp_network):
    """
...
def test_rhel_8_network_manager_is_disabled(rhel_8_dhcp_network):
    """
...
def test_rhel_8_persistent_interface_names(rhel_8_dhcp_network):
    """
