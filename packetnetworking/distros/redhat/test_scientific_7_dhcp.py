...
@pytest.fixture
def scientific_7_dhcp_network(generic_redhat_dhcp_network):
    def _builder(**kwargs):
        return generic_redhat_dhcp_network("scientificcernslc", "7", **kwargs)

    return _builder


def test_scientific_7_dhcp_task_etc_sysconfig_network(
    scientific_7_dhcp_network
):
    """Validates /etc/sysconfig/network for dhcp"""
    builder = scientific_7_dhcp_network(public=True)
...
def test_scientific_7_dhcp_task_etc_sysconfig_network_scripts_ifcfg_enp0(
    scientific_7_dhcp_network
):
    """Validates /etc/sysconfig/network-scripts/ifcfg-enp0 for dhcp"""
    builder = scientific_7_dhcp_network(public=True)
    tasks = builder.render()
    result = dedent(
        """\
...
def test_scientific_7_private_dhcp_task_etc_sysconfig_network_scripts_ifcfg_enp0(
    scientific_7_dhcp_network
):
    """
    ...
    """
    builder = scientific_7_dhcp_network(public=False)
    tasks = builder.render()
    result = dedent(
        """\
        DEVICE=enp0
...
def test_scientific_7_private_route_task_etc_sysconfig_network_scripts_route_enp0_with_custom_private_subnets(
    ...
    builder = scientific_7_dhcp_network(public=True, metadata=subnets)
    tasks = builder.render()
    result = dedent(
        """\
...
def test_scientific_7_etc_resolvers_configured(scientific_7_dhcp_network, fake):
    """
    Validates /etc/resolv.conf is configured correctly
    """
    builder = scientific_7_dhcp_network()
    resolver1 = fake.ipv4()
    resolver2 = fake.ipv4()
...
def test_scientific_7_etc_hostname_configured(scientific_7_dhcp_network):
    """
...
def test_scientific_7_etc_hosts_configured(scientific_7_dhcp_network):
    """
...
def test_scientific_7_network_manager_is_disabled(scientific_7_dhcp_network):
    """
...
def test_scientific_7_persistent_interface_names(scientific_7_dhcp_network):
    """
