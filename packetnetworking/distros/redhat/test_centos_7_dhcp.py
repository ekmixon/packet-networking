...
@pytest.fixture
def centos_7_dhcp_network(generic_redhat_dhcp_network):
    def _builder(**kwargs):
        return generic_redhat_dhcp_network("centos", "7", **kwargs)

    return _builder


def test_centos_7_dhcp_task_etc_sysconfig_network(
    centos_7_dhcp_network
):
    """Validates /etc/sysconfig/network for dhcp"""
    builder = centos_7_dhcp_network(public=True)
...
def test_centos_7_dhcp_task_etc_sysconfig_network_scripts_ifcfg_enp0(
    centos_7_dhcp_network
):
...
def test_centos_7_private_dhcp_task_etc_sysconfig_network_scripts_ifcfg_enp0(
    centos_7_dhcp_network
):
    """
    ...
    """
    builder = centos_7_dhcp_network(public=False)
    tasks = builder.render()
    result = dedent(
        """\
        DEVICE=enp0
...
def test_centos_7_private_route_task_etc_sysconfig_network_scripts_route_enp0_with_custom_private_subnets(
    ...
    builder = centos_7_dhcp_network(public=True, metadata=subnets)
    tasks = builder.render()
    result = dedent(
        """\
...
def test_centos_7_etc_resolvers_configured(centos_7_dhcp_network, fake):
    """
    Validates /etc/resolv.conf is configured correctly
    """
    builder = centos_7_dhcp_network()
    resolver1 = fake.ipv4()
    resolver2 = fake.ipv4()
...
def test_centos_7_etc_hostname_configured(centos_7_dhcp_network):
    """
...
def test_centos_7_etc_hosts_configured(centos_7_dhcp_network):
    """
...
def test_centos_7_network_manager_is_disabled(centos_7_dhcp_network):
    """
